            ...
            <div className="w-full">
              ...
              <form>
                ...
                <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                  ...
                  <button className="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-pink-600 rounded-md hover:bg-yellow-700 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                    <span>Sign Up </span>
